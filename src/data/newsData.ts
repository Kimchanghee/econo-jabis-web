...
export const RSS_FEEDS: Record<Language, { url: string; category: Category; source: string }[]> = {
  ko: [
    {
      url: "https://api.allorigins.win/raw?url=https://www.hankyung.com/feed/all-news",
      category: "주식",
      source: "한국경제",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://www.mk.co.kr/rss/30000001/",
      category: "주식",
      source: "매일경제",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://www.yna.co.kr/rss/economy.xml",
      category: "주식",
      source: "연합뉴스",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://biz.chosun.com/rss/site.xml",
      category: "주식",
      source: "조선비즈",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://land.naver.com/news/newslist.nhn?rss=y",
      category: "부동산",
      source: "네이버부동산",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://coinreaders.com/rss/",
      category: "암호화폐",
      source: "CoinReaders",
    },
  ],
  en: [
    {
      url: "https://api.allorigins.win/raw?url=https://feeds.reuters.com/reuters/businessNews",
      category: "주식",
      source: "Reuters",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://feeds.content.dowjones.io/public/rss/mw_topstories",
      category: "주식",
      source: "MarketWatch",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://rss.app/feeds/yOjSFTBQo7H5Iyss.xml",
      category: "주식",
      source: "Financial Times",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://feeds.a.dj.com/rss/RSSMarketsMain.xml",
      category: "주식",
      source: "WSJ Markets",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://cointelegraph.com/rss",
      category: "암호화폐",
  ...
  es: [
    {
      url: "https://api.allorigins.win/raw?url=https://www.eleconomista.es/rss/rss-mercados-financieros.php",
      category: "주식",
      source: "El Economista",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://e00-expansion.uecdn.es/rss/mercados.xml",
      category: "주식",
      source: "Expansión",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://www.cronista.com/files/rss/rss_mercados.xml",
      category: "주식",
      source: "El Cronista",
    },
  ],
  ja: [
    {
      url: "https://api.allorigins.win/raw?url=https://www3.nhk.or.jp/rss/news/cat5.xml",
      category: "주식",
      source: "NHK経済",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://jp.reuters.com/rssFeed/businessNews/",
      category: "주식",
      source: "ロイター",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://coinpost.jp/?feed=rss2",
      category: "암호화폐",
      source: "CoinPost",
    },
  ],
  zh: [
    {
      url: "https://api.allorigins.win/raw?url=https://feed.sina.com.cn/api/roll/get?pageid=153&lid=2516&num=20&type=json",
      category: "주식",
      source: "新浪财经",
    },
    {
      url: "https://api.allorigins.win/raw?url=https://feed.eastmoney.com/news/1344.html",
      category: "주식",
      source: "东方财富",
    },
  ],
...
export const fallbackArticles: NewsArticle[] = [
  {
    ...
    summary:
      "외국인 투자자들의 대규모 매수세에 힘입어 코스피 지수가 2,700선을 돌파했다. 삼성전자와 SK하이닉스 등 반도체 관련주가 강세를 보이며 지수 상승을 이끌었다.",
    category: "주식",
    source: "한국경제",
  ...
  },
  {
    ...
    summary:
      "서울 아파트 매매가격이 3주 연속 상승세를 기록했다. 특히 강남구, 서초구 등 강남권을 중심으로 거래가 활발해지면서 가격 상승폭이 확대되고 있다.",
    category: "부동산",
    source: "매일경제",
    date: new Date().toISOString().split("T")[0],
  ...
  },
  {
    ...
    summary:
      "비트코인이 10만 달러를 다시 돌파하며 강세장을 이어가고 있다. 대형 기관 투자자들의 유입이 가속화되면서 시장 낙관론이 확산되고 있다.",
    category: "암호화폐",
    source: "블록미디어",
    date: new Date().toISOString().split("T")[0],
  ...
  },
  {
    ...
    summary:
      "원/달러 환율이 1,350원대에 안착했다. 미국 연방준비제도의 금리 동결 결정과 한국은행의 추가 인하 기대감이 환율에 영향을 미치고 있다.",
    category: "환율",
    source: "조선비즈",
    date: new Date().toISOString().split("T")[0],
  ...
  },
  {
    ...
    summary:
      "삼성전자가 차세대 고대역폭 메모리(HBM4)의 양산 계획을 공식 발표했다. AI 반도체 시장에서의 경쟁력 강화를 위한 전략으로 분석된다.",
    category: "주식",
    source: "전자신문",
    date: new Date().toISOString().split("T")[0],
    imageUrl: FALLBACK_IMAGES["주식"],
