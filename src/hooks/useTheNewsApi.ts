...
const REQUIRED_KEYWORDS = [
    ...
    "주가", "나스닥", "다우", "상승", "하락", "매수", "매도",
    // 경제/금융
    "economy", "economic", "finance", "financial", "gdp", "inflation",
    "interest rate", "federal reserve", "central bank", "monetary",
    "recession", "growth", "market", "fiscal", "trade", "export", "import",
    "경제", "금융", "금리", "물가", "인플레이션", "환율", "무역", "수출", "수입",
    "기준금리", "한국은행", "연준", "fed", "ecb",
    // 기업분석
    "revenue", "profit", "earnings", "quarterly", "annual report",
    "merger", "acquisition", "ipo", "corporate", "ceo", "cfo",
    "실적", "매출", "영업이익", "순이익", "기업", "분기", "인수합병",
    "상장기업", "코스닥기업", "유가증권",
    // 크립토/암호화폐
    "bitcoin", "crypto", "cryptocurrency", "blockchain", "ethereum",
    "btc", "eth", "defi", "nft", "token", "coin", "web3", "altcoin",
    "stablecoin", "mining", "wallet", "exchange", "binance", "upbit",
    "비트코인", "암호화폐", "블록체인", "이더리움", "코인", "토큰", "디파이",
    "업비트", "빗썸",
    // 부동산/자산
    "real estate", "reits", "property investment",
    "부동산투자", "리츠",
    // 은행/보험
    "bank", "banking", "insurance", "fintech", "은행", "금융", "보험", "핀테크",
  ];

// 경제/금융/주식/크립토 API 검색 쿼리
const FINANCE_SEARCH_QUERY = "stock OR economy OR finance OR crypto OR bitcoin OR earnings OR market OR investment OR IPO OR merger OR acquisition OR GDP OR inflation OR 주식 OR 경제 OR 기업 OR 암호화폐 OR 코스피 OR 나스닥 OR 실적 OR 금융";
...
const detectCategory = (title: string, description: string): Category => {
    ...
    const keywords: Record<Category, string[]> = {
          "주식": [
                  "stock", "equity", "shares", "market", "nasdaq", "s&p", "kospi", "주식", "증시",
                  "ipo", "earnings", "dividend", "wall street", "bull", "bear", "rally",
                  "주가", "코스피", "코스닥", "나스닥", "다우", "상장", "배당", "투자",
                ],
          "부동산": ["real estate", "housing", "property", "부동산", "아파트", "不動産", "房产"],
          "환율": ["forex", "exchange rate", "currency", "dollar", "euro", "yen", "won", "환율", "달러", "為替", "汇率"],
          "암호화폐": [
                  "bitcoin", "crypto", "blockchain", "ethereum", "btc", "eth", "defi", "nft",
                  "token", "coin", "web3", "altcoin", "stablecoin", "binance", "upbit",
                  "비트코인", "암호화폐", "블록체인", "이더리움", "코인", "토큰", "디파이", "업비트", "빗썸",
                ],
          "전체": [],
    };
