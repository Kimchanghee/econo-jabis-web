...
const BLOCKED_KEYWORDS = [
    ...
    "인테리어", "육아", "반려", "레시피", "recipe", "gaming", "celebrity",
    "entertainment", "movie", "film", "music", "fitness", "diet",
...
const TRENDING_KEYWORDS_MAP: Record<string, string> = {
    ...
    "inflation": "인플레이션", "interest rate": "금리", "federal reserve": "연준",
    "fed": "연준", "kospi": "코스피", "kosdaq": "코스닥", "nasdaq": "나스닥",
    "dow": "다우", "s&p": "S&P500", "gdp": "GDP", "recession": "경기침체",
    "etf": "ETF", "ipo": "IPO", "dividend": "배당", "crypto": "암호화폐",
    "ethereum": "이더리움", "real estate": "부동산", "oil": "원유",
    "gold": "금값", "semiconductor": "반도체", "AI": "AI",
    "삼성": "삼성", "SK": "SK", "현대": "현대", "카카오": "카카오",
    "네이버": "네이버", "환율": "환율", "무역": "무역", "수출": "수출",
    "tesla": "테슬라", "nvidia": "엔비디아", "apple": "애플", "google": "구글",
    "코스피": "코스피", "코스닥": "코스닥", "비트코인": "비트코인",
    "금리": "금리", "주식": "주식", "경제": "경제", "부동산": "부동산",
    "반도체": "반도체", "인공지능": "AI", "인플레이션": "인플레이션",
    "한국은행": "한국은행",
};
...
function mapToNewsArticle(a: TheNewsAPIArticle, index: number): NewsArticle {
    const catMap: Record<string, Category> = {
          business: "주식", finance: "주식", tech: "주식", general: "전체",
          science: "전체", health: "전체", sports: "전체", entertainment: "전체",
    };
    const cat: Category = a.categories?.[0]
      ? (catMap[a.categories[0]] || "전체")
          : "전체";
