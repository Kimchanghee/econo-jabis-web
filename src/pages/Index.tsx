...
// ADSTERRA_BANNER_LOADER document.currentScript override
function loadAdsterraBanner(el: HTMLElement, key: string, width: number, height: number, isNative = false) {
  if (isNative) {
...
const Banner728x90Ad = ({ instanceId }: { instanceId: string }) => {
  ...
  return (
    <div
      ...
      style={{ minHeight: "90px", width: "100%", maxWidth: "728px", margin: "0 auto" }}
    />
  );
};
